...
module.exports = {
    ...
    checkout: async(req, res) =>{
        try {
            const {accountUser, name, voucher, bank, nominal, payment} =  req.body;
            ...
            const payload ={
                ...
                historyPayment : {
                    ...
                    nomorRekening : res_bank._doc.nomorRekening
                },
                name: name,
    ...
    historyDetail : async(req, res) =>{
        try {
            ...
            if(!history) res.status(401).json({message: 'History Not Found' });
    ...
    editProfile : async(req, res) =>{
        try {
            ...
            if(req.file){
                ...
                const player =  await Player.findOneAndUpdate({_id: req.player.id},payload,{
                    new : true, newValidators : true
                });
                res.status(201).json({
                    data: {
